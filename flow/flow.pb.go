...
type Request struct {
	...
	// options is a map of any settings required to configure the Flow.
	Options map[string]*Value `protobuf:"bytes,2,rep,name=options" json:"options,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *Request) GetOptions() map[string]*Value {
	if m != nil {
		return m.Options
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
